...
#pragma region Constraints
    ...
    for (int t = 0; t < T; t++)
    {
        ...
        model.add(Pdg1[t] + Pdg2[t] + Rdg1[t] + Pchp1[t] + Pchp2[t] + Bdischg[t] + exp1 - exp0 - Bchg[t] + PGbuy[t] - PGsell[t] == Pload[t]);
...
#pragma region StoringOutput
    ...
    if (outputFile.is_open()) {
        ...
        outputFile << "Time,Pload,Hload,CGbuy,CGsell,CHsell,CHbuy,Rdg1,PGbuy,PGsell,statoc,Bchg,Bdischg,Pdg1,Pdg2,Pchp1,Pchp2,Hhob,Hchp1,Hchp2,HGbuy,HGsell,Hchg,Hdisch" ;
